...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype , String meter){
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("Icons/icon7.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("Icons/icon7.png"));
